...
// ============================================================
// CU13 (ext.) — Registrar Asistencia (Docente)
// El docente solo puede registrar asistencia en grupos
// que le hayan sido asignados.
// ============================================================
class AsistenciaController extends Controller
{
    // GET /v1/asistencia?grupo_id=X&convocatoria_id=Y&fecha=YYYY-MM-DD
    // Devuelve la lista de postulantes del grupo con su estado de asistencia
    // para la fecha indicada (o 'presente' por defecto si no hay registro aún).
    public function index(Request $request): JsonResponse
    {
        ...
        // Verificar que el docente está asignado a este grupo
        ...
        // Postulantes inscritos en este grupo
    ...
    // POST /v1/asistencia
    // Guarda (o actualiza) el pase de lista completo para un grupo y fecha.
