...
// ============================================================
// CU13 — Asignar Carga Horaria Docente
// Regla de negocio: un docente puede tener máximo 4 grupos
// por convocatoria.
// ============================================================
class AsignacionDocenteController extends Controller
{
    ...
    public function cargaHoraria(int $ci): JsonResponse
    {
        ...
        // Quien solo tiene 'Ver carga horaria propia' solo puede ver la suya
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        // Regla de negocio: máximo 4 grupos por docente por convocatoria
